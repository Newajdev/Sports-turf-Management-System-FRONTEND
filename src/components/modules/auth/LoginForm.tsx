...
const AUTH_ERROR_MESSAGES: Record<string, string> = {
  ...
  no_session_found: "Sign-in session expired. Please try logging in again.",
  no_user_found: "We could not find your account. Please register first.",
};
            ...
            >
              {([canSubmit, isSubmitting]) => (
                <FormSubmitBtn
                  ...
                  disabled={!canSubmit}
                  className="w-full bg-primary py-6 text-xl hover:bg-primary/90 text-primary-foreground shadow-lg transition-all active:scale-[0.98]"
                >
                  Log In
                </FormSubmitBtn>
              )}
