...
import { ResetPasswordAction } from "@/app/(commonLayout)/(authRoutes)/auth/reset-password/_action";
        ...
        <CardContent className="space-y-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-3">
              <Label className="text-sm font-semibold text-foreground/80 block text-center uppercase tracking-wide">
                Verification Code
              </Label>
              <div className="flex justify-center">
                ...
                >
                  <InputOTPGroup>
                    <InputOTPSlot
                      index={0}
                      className="w-10 h-12 text-lg font-bold border-2 bg-white/5 border-muted-foreground/20"
                    />
                    <InputOTPSlot
                      index={1}
                      className="w-10 h-12 text-lg font-bold border-2 bg-white/5 border-muted-foreground/20"
