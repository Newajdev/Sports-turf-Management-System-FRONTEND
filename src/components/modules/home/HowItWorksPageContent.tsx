            ...
            <div className="flex-1 space-y-12">
              <div className="space-y-6">
                ...
                <p className="text-muted-foreground text-xl leading-relaxed max-w-xl">
                  We did not just build a booking app. We built a high-performance
                  operating system for the field.
                </p>
              </div>
                ...
                {[
                  ...
                  <div key={i} className="flex gap-8 group">
                    ...
                    <div className="space-y-2">
                      <h4 className="text-xl font-black uppercase italic text-white group-hover:text-primary transition-colors">
                        {f.t}
                      </h4>
                      <p className="text-muted-foreground leading-relaxed">
                        {f.d}
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          ...
          <div className="space-y-6">
            {[
              ...
              <div
                key={i}
                className="group p-10 rounded-[2.5rem] bg-white/[0.02] border border-white/5 hover:border-primary/20 transition-all cursor-pointer"
              >
                <div className="flex items-center justify-between">
                  <h4 className="text-xl font-bold uppercase italic text-white/80 group-hover:text-primary transition-colors pr-8">
                    {item.q}
                  </h4>
