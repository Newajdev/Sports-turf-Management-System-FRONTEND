...
export const createTurfSchema = z.object({
  name: z.string("Turf name is required"),
  ...
  openingTime: z.string("Opening time is required"),
  closingTime: z.string("Closing time is required"),
  weeklyOffDays: z.array(z.nativeEnum(WeeklyOffDay)).optional().default([]),
  isAlwaysOpen: z.boolean().optional().default(false),
  hourlyRate: z.number("Hourly rate is required").min(0),
