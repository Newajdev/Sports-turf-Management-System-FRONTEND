...
export default async function BlogDetailPage({
  ...
  if (!response?.success || !response.data) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] bg-background text-foreground p-6">
        <h2 className="text-3xl font-black italic uppercase text-primary mb-4">
          Insight Not Found
        </h2>
  ...
  const blog: IBlog = response.data as IBlog;
    ...
    <div className="flex flex-col w-full min-h-screen bg-background pb-32">
      ...
      <div className="container mx-auto px-4 md:px-6 -mt-16 relative z-20">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Main Featured Image */}
          <div className="relative h-62.5 md:h-125 w-full rounded-[2rem] overflow-hidden border border-white/10 shadow-2xl mb-12">
            <Image
          ...
          <div className="bg-card/50 backdrop-blur-sm border border-white/5 rounded-[3rem] p-8 md:p-16 mb-12">
            ...
            <article className="prose prose-invert prose-emerald max-w-none">
              <p className="text-xl text-white/80 leading-relaxed italic border-l-4 border-primary pl-6 mb-12">
                {blog.excerpt}
              </p>
              ...
              {blog.content
                ...
                .map((paragraph: string, i: number) => {
                  ...
                  return (
                    <div
                      key={i}
                      className="mb-8 text-muted-foreground text-lg leading-loose"
                    >
                      {trimmed.startsWith("##") ? (
          ...
          <BlogInteractions
            ...
            initialActiveReactionType={blog.activeReactionType ?? null}
