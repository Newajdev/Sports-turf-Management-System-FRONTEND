          ...
          <div className="max-w-4xl mx-auto bg-card p-12 md:p-20 rounded-[3rem] border border-white/5 shadow-2xl">
            <div className="prose prose-invert prose-emerald max-w-none space-y-12">
               <div className="space-y-4">
                  <h3 className="text-2xl font-black text-white uppercase italic tracking-tight">1. Acceptance of Terms</h3>
               ...
               <div className="space-y-4">
                  <h3 className="text-2xl font-black text-white uppercase italic tracking-tight">2. Booking & Payments</h3>
                  <p className="text-muted-foreground leading-loose">
               ...
               <div className="space-y-4">
                  <h3 className="text-2xl font-black text-white uppercase italic tracking-tight">3. User Responsibilities</h3>
                     <p className="text-muted-foreground leading-loose">
